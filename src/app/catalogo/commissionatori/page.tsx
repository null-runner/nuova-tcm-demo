...
export const metadata: Metadata = {
  title: "Commissionatori CAT® Lift Trucks",
  description: "Commissionatori CAT® Lift Trucks. Portata 1000-2000 kg. Dealer ufficiale in Emilia-Romagna. Nuovi, usati e a noleggio.",
};
...
const models = [
  ...
  },
  {
    ...
    "capacity_kg": 1250,
    "loadCenter_mm": 600,
    "battery": "48V/500Ah (MAX 620Ah)",
    "maxLiftHeight_mm": 10500,
    "image": "/images/catalog/commissionatori/NOH12PH-product.png",
    "brochure": null
  }
];
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <AnimatedSection>
            ...
            <p className="font-mono text-brand-accent text-xs tracking-[0.2em] uppercase mb-3">
              Carrelli commissionatori per altezze basse ed alte
            </p>
