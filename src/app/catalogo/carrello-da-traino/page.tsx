...
export const metadata: Metadata = {
  title: "Carrelli da Traino CAT® Lift Trucks",
  description: "Carrelli da Traino CAT® Lift Trucks. Portata 3000-5000 kg. Dealer ufficiale in Emilia-Romagna. Nuovi, usati e a noleggio.",
};

const models = [
  {
    "name": "NTR30-50N2",
    "capacity_kg": "3000/5000",
    "loadCenter_mm": null,
  ...
  return (
    <>
      <BreadcrumbSchema items={[
        ...
        { name: "carrello-da-traino", href: "/catalogo/carrello-da-traino" },
      ]} />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <AnimatedSection>
            ...
            <p className="font-mono text-brand-accent text-xs tracking-[0.2em] uppercase mb-3">
              Capacita di rimorchio fino a un peso totale di 5000kg
            </p>
            <h1 className="font-display text-4xl sm:text-5xl font-bold text-white mb-4">
              Carrelli da Traino
            </h1>
            <p className="text-brand-text-muted text-lg">
              Portata: 3000-5000 kg
            </p>
          </AnimatedSection>
        </div>
      </section>
